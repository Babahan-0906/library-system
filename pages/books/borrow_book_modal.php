                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="form-group col-md-6">
                                ...
                                <input readonly type="number" class="form-control" name="b_book_id" id="b_book_id" placeholder="Book ID">
                            </div>
                            <div class="form-group col-md-6">
                        ...
                        <div class="form-group ">
                            <label for="b_book_quantity">Quantity</label> <span class="" style="float: right;"> <span id="left_book" name="b_book_left"></span> left</span>
                            <input type="number" class="form-control" name="b_book_quantity" id="b_book_quantity" placeholder="Quantity" min=1 value=1>
                        </div>
                            <button type="submit" id="b_submit" name="b_submit" class="btn btn-primary">Borrow</button>
